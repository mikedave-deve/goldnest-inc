...
const TransactionsManagement = () => {
  ...
  const getTypeBadge = (type) => {
    ...
    return (
      <span className={`px-3 py-1 rounded-full text-xs border font-semibold ${styles[type] || styles.deposit}`}>
        {type.toUpperCase()}
      </span>
    );
  };
    ...
    <div className="min-h-screen bg-[#111] text-white font-sans">
      ...
      <main className="px-4 md:px-10 lg:px-20 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
          ...
          <div className="flex space-x-3 mt-4 md:mt-0">
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded font-semibold flex items-center space-x-2"
            >
            ...
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded font-semibold flex items-center space-x-2"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          <div className="bg-blue-500/10 border border-blue-500 rounded-lg p-6">
            ...
            <h3 className="text-2xl font-bold text-blue-400">{stats.total}</h3>
          </div>
          ...
          <div className="bg-green-500/10 border border-green-500 rounded-lg p-6">
            ...
            <h3 className="text-2xl font-bold text-green-400">${stats.deposits.toFixed(2)}</h3>
          </div>
          ...
          <div className="bg-purple-500/10 border border-purple-500 rounded-lg p-6">
            ...
            <h3 className="text-2xl font-bold text-purple-400">${stats.withdrawals.toFixed(2)}</h3>
          </div>

          <div className="bg-yellow-500/10 border border-yellow-500 rounded-lg p-6">
            <p className="text-gray-400 text-sm mb-1">Total Earnings</p>
            <h3 className="text-2xl font-bold text-yellow-400">${stats.earnings.toFixed(2)}</h3>
          </div>
        </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
          <div className="bg-[#1a1a1a] border border-green-500 rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
            <h3 className="text-xl font-semibold text-green-400 mb-4">Create Transaction</h3>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-black border border-gray-700 rounded pl-10 pr-10 py-2 text-white"
